...
#let cover(
  ...
  pad(left:-first-line-indent)[#grid(columns: (12fr, 12fr, 12fr), rows: (auto,), gutter: 0pt, align(center)[
    ...
    #block(text(problem-chosen, size: 30pt, fill: black, weight: "bold"))
  ], align(center)[
    #text(year, size: 14pt, weight: "bold")
    #text("\nMCM/ICM\nSummary Sheet", size: 14pt, weight: "bold")
  ], align(center)[
    #block(text("Team Control Number", size: 14pt, weight: "bold"))
    #block(text(team-number, size: 30pt, fill: black, weight: "bold"))
  ])]
