...
#let cover(
  ...
  // Team Infomation
  pad(left:-first-line-indent)[#grid(columns: (12fr, 12fr, 12fr), rows: (auto,), gutter: 0pt, align(center)[
    #block(text("Problem Chosen", size: fontsize, weight: "bold"))
    #block(text(problem-chosen, size: 20pt, fill: red, weight: "bold"))
  ], align(center)[
    #text(year, size: fontsize, weight: "bold")
    #text("\nMCM/ICM\nSummary Sheet", size: fontsize, weight: "bold")
  ], align(center)[
    #block(text("Team Control Number", size: 12pt, weight: "bold"))
    #block(text(team-number, size: 20pt, fill: red, weight: "bold"))
  ])]
...
#let project(
  ...
  // contents
  set page(margin: (left: 60pt, right: 50pt, top: 60pt, bottom: 40pt))
  set par(
  ...
  set page(
    header-ascent: 20%,
    margin: (left: 80pt, right: 50pt, top: 60pt, bottom: 60pt),
  )
